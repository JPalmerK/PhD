%% Average TL %%
% Apr 14 2016- This code is oudtated see. UnconditionalPdeta as fx of Noise

% The goal of this code is to determine the average TL over the click
% bandwidth

% The output will be the scaled, frequency corrected transmission loss as a
% for each deployment location as a function of range

% The average TL grid may then be put into the Area vs Noise code to create
% an array for each deployment location linking TL to NL. This then goes
% into either the bayesian model or the actual calculations for area
