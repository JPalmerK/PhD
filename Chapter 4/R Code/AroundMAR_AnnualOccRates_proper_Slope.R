...
OccTable_daily=merge(OccTable_daily, meta2, by='UnitLoc', all.x = TRUE)
...
for(ii in 1:10){
    ...
    newdat_perdOnly$ShoreDist=sort(rep(c('05', '10', '15'),nrow(newdat_perdOnly)/3))
    ...
    null=geeglm(OccAll~Slope2+Year, 
                         corstr = 'ar1', 
                         offset = BNDTotOffset, 
                         family = binomial, 
                         id     = UnitLoc, 
    ...
    mod1=geeglm(OccAll~Slope2+Year+bs(JulienDay, knots = mean(JulienDay)), 
                corstr = 'ar1', 
                offset = BNDTotOffset, 
                family = binomial, 
                id     = UnitLoc, 
    ...
    mod2=geeglm(OccAll~Slope2+Year+JulienDay, 
                corstr = 'ar1', 
                offset = BNDTotOffset, 
                family = binomial, 
                id     = UnitLoc, 
    ...
    mod1=geeglm(OccAll~Slope2+bs(JulienDay, knots = mean(JulienDay)), 
                corstr = 'ar1', 
                offset = BNDTotOffset, 
                family = binomial, 
                id     = UnitLoc, 
    ...
    mod2=geeglm(OccAll~Slope2+JulienDay, 
                corstr = 'ar1', 
                offset = BNDTotOffset, 
                family = binomial, 
                id     = UnitLoc, 
    ...
    mod1=geeglm(as.formula(paste('OccAll~', JdateForm, '+ Slope2 + Year')), 
                corstr = 'ar1', 
                offset = BNDTotOffset, 
                family = binomial, 
                id     = UnitLoc, 
    ...
    mod2=geeglm(as.formula(paste('OccAll~', JdateForm, '+ Slope2')), 
                corstr = 'ar1', 
                offset = BNDTotOffset, 
                family = binomial, 
                id     = UnitLoc, 
    ...
    mod4=geeglm(OccAll~Slope2+Year, 
                corstr = 'ar1', 
                offset = BNDTotOffset, 
                family = binomial, 
                id     = UnitLoc, 
    ...
    Qicdf$Varnames=c('All',  'Year', 'Slope2' , JdateForm)
    ...
    OneYearAggs=data.frame(aggregate(data=subset(data_sub, Year==unique(newdat_perdOnly$Year)),
                                                      OccAll~DayBin+GroupId+Slope2, FUN=mean))
    OneYearAggs=cbind(OneYearAggs,
                      aggregate(data=subset(data_sub, Year==unique(newdat_perdOnly$Year)), 
                                JulienDay~DayBin+GroupId+Slope2, FUN=median)[,4])
   
    OneYearAggs=cbind(OneYearAggs,
                      aggregate(data=subset(data_sub, Year==unique(newdat_perdOnly$Year)),
                                     BNDTotOffset~DayBin+GroupId+Slope2, FUN=mean))
...
ggplot(data=dummyfit) +
  ...
  geom_line(aes(DummyDate, inv.logit(fit), colour=as.factor(Slope2)), size=1) +
